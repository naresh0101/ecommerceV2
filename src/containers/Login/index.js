      ...
      return (
        <Fragment>
              ...
              <div className="p-4 lg:w-1/2 md:w-full mt-8">
                <div className="flex  rounded-lg p-8 sm:flex-row flex-col">
                   <form className="flex-grow"  method="POST" onSubmit={LoginForm}>
                    <h2 className="text-gray-900 text-lg title-font font-medium mb-3">Login</h2>
                    ...
                    <Link to="/signup" className="mt-3 border-2 p-2 rounded text-indigo-500 inline-flex items-center ">Sign Up
                      <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-4 h-4 ml-2" viewBox="0 0 24 24">
                        <path d="M5 12h14M12 5l7 7-7 7"></path>
                      </svg>
                    </Link>
                    <button type="submit" className="mt-3 border-2 p-2 rounded text-indigo-500 inline-flex items-center float-right">Login
                      <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-4 h-4 ml-2" viewBox="0 0 24 24">
                        <path d="M5 12h14M12 5l7 7-7 7"></path>
                      </svg>
                    </button>
